...
// compiled with 
//  gcc -o ode ode.c -I/opt/homebrew/Cellar/sundials/6.6.0/include -L/opt/homebrew/Cellar/sundials/6.6.0/lib -lsundials_cvode -lsundials_nvecserial -lsundials_arkode
