...
#[derive(Debug, Clone, Deserialize, Serialize)]
pub struct Equation {
    pub variable: String, // the primary variable of the equation (e.g., x, y, etc.)
    pub expression: Ex,
...
pub fn translate_expression_to_code(
    expr: &Ex,
...
pub fn generate_function_from_system(system: &ODESystem) -> String {
...
pub fn extract_initial_conditions_and_parameters(system: &ODESystem) -> (Vec<f64>, Vec<f64>) {
...
pub fn transform_to_first_order(system: &System) -> System {
...
pub fn lorenz_sys() -> (ODESystem, [f64; 3], [f64; 3]) {
